 ...
 * @author Admin
 */
@WebServlet(name = "DisplayMyOrderController", urlPatterns = {"/DisplayMyOrderController"})
public class DisplayMyOrderController extends HttpServlet {

    public static final String ERROR = "error.jsp";
    public static final String SUCESSFUL = "myOrder.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<OrderDTO> listOrder = dao2.getMyOrder(cusID);
            session.setAttribute("LIST_MY_ORDER", listOrder);
            url = SUCESSFUL;
        } catch (Exception e) {
