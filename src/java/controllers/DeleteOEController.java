...
@WebServlet(name = "DeleteOEController", urlPatterns = {"/DeleteOEController"})
public class DeleteOEController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.delete(officeEmpID);
            if (check) {
                url = SUCCESS;
            }
