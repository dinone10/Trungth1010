 ...
 * @author Admin
 */
@WebServlet(name = "GetInfoCardController", urlPatterns = {"/GetInfoCardController"})
public class GetInfoCardController extends HttpServlet {
    
    public static final String ERROR = "error.jsp";
    public static final String SUCCESS = "createCard.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<VehicleDTO> listVehicle = dao2.getVehicleByCus(cusID);
