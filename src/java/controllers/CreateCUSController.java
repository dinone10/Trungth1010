 ...
 * @author Admin
 */
@WebServlet(name = "CreateCUSController", urlPatterns = {"/CreateCUSController"})
public class CreateCUSController extends HttpServlet {

    private static final String ERROR = "addCUS.jsp";
