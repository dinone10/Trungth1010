...
public class UserDAO {
    ...
    private static final String LOGIN = "SELECT userID, fullname, roleID, address, birthday, phone, email FROM tblUsers WHERE userID=? AND password =?";
    private static final String SEARCH = "SELECT userID, fullName, roleID, address, birthday, phone, email FROM tblUsers WHERE fullName like ? ";
    ...
    private static final String CREATE = "INSERT INTO tblUsers(userID, fullName, roleID, password, address, birthday, phone, email) VALUES(?,?,?,?,?,?,?,?)";
