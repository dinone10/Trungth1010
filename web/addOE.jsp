        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 align="center">
                        <i class="fa fa-keyboard-o"></i> Add Office Employees Encoding
                        <small></small>
                    </h1>
                </section>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  placeholder="Enter Office Employees ID" name="officeEmpID" value="<%= officeEmpID%>" ><%= oeError.getOfficeEmpIDError()%>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Office Employees Name</label>
                                                        <input type="text" class="form-control"  placeholder="Office Employees Name" name="officeEmpName" value="<%= officeEmpName%>" ><%= oeError.getOfficeEmpNameError()%>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Phone</label>
                                                        <input type="text" class="form-control"  placeholder="Phone" name="phone" value="<%= phone%>" ><%= oeError.getPhoneError()%>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Email</label>
                                                        <input type="text" class="form-control"  placeholder="Enter Office Employees Email" name="email" value="<%= email%>" ><%= oeError.getEmailError()%>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Account ID</label>
                                                        <input type="text" class="form-control"  placeholder="Enter Account ID" name="idAccount" value="<%= idAccount%>" ><%= oeError.getIdAccountError()%>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <a href="MainController?action=displayOE"><button type="button"  class="btn btn-danger pull-left" >Close</button></a>
