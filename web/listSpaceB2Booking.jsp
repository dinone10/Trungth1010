...
<html lang="en">
    ...
    <body>
        ...
        <!-- Nav Bar End -->
        <%  List<SpaceDTO> listAll = (List<SpaceDTO>) session.getAttribute("LIST_SPACE_B2");
                    ...
                    <div class="col-sm-12 middle">
                        ...
                        <div class="middle_1 clearfix">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a data-toggle="tab" href="MainController?action=listSpaceB2">Block B2</a></li>                             
                            </ul>
                            <%
