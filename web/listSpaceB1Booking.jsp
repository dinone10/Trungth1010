...
<html lang="en">
    ...
    <body>
        ...
        <!-- Nav Bar End -->
        <%  List<SpaceDTO> listAll = (List<SpaceDTO>) session.getAttribute("LIST_SPACE_B1");
                    ...
                    <div class="col-sm-12 middle">
                        ...
                        <div class="middle_1 clearfix">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a  href="MainController?action=listSpaceB1&userName=<%= request.getParameter("userName")%>">Block B1</a></li>
