                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title"><i class="fa fa-car"></i> My Long Term Card Data Table</h3>
                                ...
                                <a href="MainController?action=getHome&userName=<%= request.getParameter("userName")%>">  <button type="button"  class="btn btn-success btn-sm" style="margin-left: 2%">
                                        <i class="fa fa-backward"></i> Booking more
                                    </button></a>
                                <div class="box-body">
                                    <%  List<CardDTO> listAll = (List<CardDTO>) session.getAttribute("LIST_MY_CARD_BY_ID");
                                        if (listAll != null) {
                                            if (!listAll.isEmpty()) {
                                    %>
