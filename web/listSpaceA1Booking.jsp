...
<html lang="en">
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="MainController?action=displayBooking" class="nav-item nav-link active">Booking</a>
        ...
        <!-- Nav Bar End -->
        <%  List<SpaceDTO> listAll = (List<SpaceDTO>) session.getAttribute("LIST_SPACE_A1");
                    ...
                    <div class="col-sm-12 middle">
                        ...
                        <div class="middle_1 clearfix">
                            ...
                            <ul class="nav nav-tabs">
                                <li ><a href="MainController?action=listSpace&userName=<%= request.getParameter("userName")%>">All Space</a></li>
                                <li class="active"><a  href="MainController?action=listSpaceA1&userName=<%= request.getParameter("userName")%>">Block A1</a></li>
