                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <%  List<OrderDTO> listAll = (List<OrderDTO>) session.getAttribute("LIST_ALL_ORDER");
                                        if (listAll.isEmpty()) {
                                    %>
                                    <h3>There are no orders in the list!</h3>
                                    <%
                                        }
                                        if (listAll != null) {
                                            if (!listAll.isEmpty()) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <form action="MainController">
                                                        ...
                                                        <button type="submit" style="background-color: #c3039e;" class="btn btn-sm" name="action" value="displayOrderDetail"><i class="fa fa-eye" style="color: white"></i></button>                                                     
                                                    </form> 
                                                </td>
                                            </tr>
                                            <%
