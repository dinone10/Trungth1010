                            ...
                            <div class="box">
                                <form role="form" action="MainController">
                                    <div class="modal-content">
                                        <div class="modal-header"><a href="MainController?action=displayAccount"><button type="button" class="btn btn-danger btn-sm" >
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  placeholder="Enter Account ID" name="idAccount" value="<%= idAccount%>" ><%= accountError.getIdAccountError()%>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>User Name</label>
                                                        <input type="text" class="form-control"  placeholder=" Enter User Name" name="userName" value="<%= userName%>" ><%= accountError.getUserNameError()%>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group" >
                                                        ...
                                                        <select class="form-control" name="roleID" >
                                                            <option value="OE">Office Employees</option>
                                                            <option value="CUS">Customer</option>
                                                            <option value="PAT">Parking Attendant</option>
                                                        </select>
                                                    </div>                                          
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Email</label>
                                                        <input type="text" class="form-control"  placeholder="Enter Email" name="email" value="<%= email%>" ><%= accountError.getEmailError()%>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <a href="MainController?action=displayAccount"><button type="button"  class="btn btn-danger pull-left" >Close</button></a>
                                            <button type="submit" name="action" value="createAccount" class="btn btn-primary">Submit</button>
