                                ...
                                <form role="form" action="MainController">
                                    <div class="modal-content">
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  placeholder="Enter Email" name="to">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Subject</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea  type="text" class="form-control" placeholder="" name="content" rows="4"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="action" value="sendEmail" class="btn btn-primary">Submit</button>
