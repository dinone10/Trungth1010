...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <%
            SpaceError spaceError = (SpaceError) request.getAttribute("SPACE_ERROR");
            if (spaceError == null) {
                spaceError = new SpaceError();
            }
        %>
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 align="center">
                        <i class="fa fa-keyboard-o"></i> Update Space Parking
                        <small></small>
                    </h1>
                </section>
                                ...
                                <form role="form">
                                    <div class="modal-content">
                                            ...
                                            <div class="box box-warning">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  readonly="" name="slotID" value="<%= request.getParameter("slotID")%>">
                                                    </div>                                                 
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Floor ID</label>
                                                        <input type="text" class="form-control" name="floorID"  readonly="" value="<%= request.getParameter("floorID")%>">
                                                    </div>
                                                    <div class="form-group" >
                                                        <label>Status</label>
                                                        <select class="form-control" name="status"  >
                                                            <option value="1" <%= "1".equals(request.getParameter("status")) ? " selected= '/selected'" : ""%>>Available</option>
                                                            <option value="0" <%= "0".equals(request.getParameter("status")) ? " selected= '/selected'" : ""%>>Unavailable</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" value="updateSpace" name="action" class="btn btn-primary">Submit</button>
                                        </div>
                                    </div>
                                </form>
                                <!-- /.modal -->
