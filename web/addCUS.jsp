        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 align="center">
                        <i class="fa fa-keyboard-o"></i> Add Customer Encoding
                        <small></small>
                    </h1>
                </section>
                                ...
                                <form role="form" action="MainController">
                                    <div class="modal-content">
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  placeholder="Enter Customer ID" name="cusID" value="<%=cusID%>">
                                                        <h4 style="color: red; "><%= cusError.getCusIDError()%></h4>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Customer Name</label>
                                                        <input type="text" class="form-control"  placeholder="Customer Name" name="cusName" value="<%= cusName%>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  placeholder="Enter Customer Email" name="email" value="<%= email%>">
                                                    ...
                                                    <%  List<AccountDTO> listAllID = (List<AccountDTO>) session.getAttribute("LIST_ALL_ACCOUNT");
                                                        if (listAllID != null) {
                                                            if (!listAllID.isEmpty()) {
                                                    %>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Account ID</label>
                                                        <select name="idAccount" class="form-control">
                                                            <%
                                                                for (AccountDTO idAcc : listAllID) {
                                                            %>
                                                            <option value="<%= idAcc.getIdAccount()%>"><%= idAcc.getIdAccount()%></option>
                                                            <%
                                                                        }
                                                                    }
                                                                }
                                        ...
                                        <div class="modal-footer">
                                            <a href="MainController?action=displayCUS"><button type="button"  class="btn btn-danger pull-left" >Close</button></a>
