<%-- 
    Document   : create1
    Created on : Mar 11, 2022, 9:58:40 PM
    Author     : Admin
--%>
    ...
    <body>
        ...
        <div class="signup-form">
            <form action="MainController" method="post">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="roleID" value="US" placeholder="Role ID" readonly="">                   
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="birthday" placeholder="Birthday" required="">
                ...
                <div class="form-group">
                    <button type="submit" name="action" value="Create" class="btn btn-success btn-lg btn-block">Register Now</button>
                </div>
            </form>
