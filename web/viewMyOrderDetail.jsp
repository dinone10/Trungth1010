                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-center">
                                            <a class="btn btn-danger" style="width: 100%" href="MainController?action=getHome"><i class="fa fa-spinner fa-spin"></i> Log out</a>                
                                        </div>
                                    </li>
                                </ul>
                            </li>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        <li class="header">Customer Functions</li>                                                             
                        <li class="active">
                            <a href="MainController?action=displayMyOrder&userName=<%= request.getParameter("userName")%>&cusID=<%= request.getParameter("cusID")%>">
                            ...
                            <div class="box">
                                <form role="form" action="MainController">
                                    <div class="modal-content">
                                        <div class="modal-header"><a href="MainController?action=displayMyOrder&userName=<%= request.getParameter("userName")%>&cusID=<%= request.getParameter("cusID")%>"><button type="button" class="btn btn-danger btn-sm" >
